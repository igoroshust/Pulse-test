import {DataTableConfiguration} from "./types.ts";
import {layoutTemplate} from "./templates.ts";
/**
...
export const defaultConfig: DataTableConfiguration = {
    ...
    labels: {
        ...
        searchTitle: "Поиск...", // The search input title
        perPage: "Записей на странице", // per-page dropdown label
        pageTitle: "Страница {page}", // page label used in Aria-label
        noRows: "Нет результатов", // Message shown when there are no records to show
